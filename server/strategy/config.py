...
class StrategyConfig:
    ...
    zone_eps_atr_mult: float = 0.25  # clustering radius as ATR multiple (tighter for precision)
    zone_eps_pct: float = 0.005  # clustering radius as price percentage (0.5% not 1%)
